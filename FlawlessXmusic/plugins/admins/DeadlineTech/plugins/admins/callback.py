...
from FlawlessXmusic import YouTube, app
from FlawlessXmusic.core.call import Anony
from FlawlessXmusic.misc import SUDOERS, db
from FlawlessXmusic.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from FlawlessXmusic.utils.decorators.language import languageCB
from FlawlessXmusic.utils.formatters import seconds_to_min
from FlawlessXmusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from FlawlessXmusic.utils.stream.autoclear import auto_clean
from from FlawlessXmusic.utils.stream.autoclear import auto_clean.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
        ...
        if "live_" in queued:
            ...
            if videoid == "telegram":
                ...
                try:
                    ...
                    image = None
            try:
                await flaw.skip_stream(chat_id, queued, video=status, image=image)
            except:
                return await CallbackQuery.message.reply_text(_["call_6"])
            if videoid == "telegram":
                button = stream_markup(_, chat_id)
